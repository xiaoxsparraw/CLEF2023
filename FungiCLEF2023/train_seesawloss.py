...
handler = logging.FileHandler(f"logs/{CFG['model_arch']}_train_seesawloss.log")
...
train_data_root = '/root/autodl-tmp/datasets/DF20/'
valid_data_root = '/root/autodl-tmp/datasets/DF21/'
...
def prepare_dataloader(train_df, val_df, train_idx, val_idx):
    ...
    valid_ds = FGVCDataset(valid_, valid_data_root, transforms=get_valid_transforms())
    ...
    for epoch in range(CFG['epochs']):
        ...
        with torch.no_grad():
            ...
            if temp_acc > best_acc:
                torch.save(model.state_dict(), './checkpoints/seesawloss_{}_mixtype_{}_mixprob_{}_seed_{}_ls_{}_epochs_{}_diffLR_{}.pth'.format(
                                                CFG['model_arch'],
                                                CFG['mix_type'],
                                                CFG['mix_prob'],
                                                CFG['seed'],
